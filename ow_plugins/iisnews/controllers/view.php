...
class IISNEWS_CTRL_View extends OW_ActionController
{
    ...
    public function index( $params )
    {
        ...
        if ( $isAuthorExists )
        {
            ...
            OW::getDocument()->setTitle(OW::getLanguage()->text('iisnews', 'news_entry_title', array('entry_title' => htmlspecialchars($entry->getTitle()), 'display_name' => $displayName)));
        ...
        if ( OW::getUser()->isAuthenticated() && ( OW::getUser()->getId() == $entry->getAuthorId() || OW::getUser()->isAuthorized('iisnews') ) )
        {
            $tb[] = array(
            ...
            $tb[] = array(
                'href' => OW::getRouter()->urlFor('IISNEWS_CTRL_Save', 'delete', array('id' => $entry->getId())),
