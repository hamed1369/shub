...
class birthdaysTest extends IISTestUtilites
{
    ...
    protected function setUp()
    {
        ...
        IISSecurityProvider::createUser($this->TEST_USER2_NAME,"user2@gmail.com",$this->TEST_PASSWORD,$birthday,"1",$accountType);
