...
<form method="post">
    <div style="<?= $_assign_vars['isConfigWritable'] ? 'display: none;' : ''; ?>" >
        <p>
            لطفا کد پایین را کپی کرده و به جای کدهای قبلی وارد نمایید. این کار را باید در فایل <b>ow_includes/config.php</b> انجام دهید. مطمین باشید که هیچ فاصله اضافی بین حروف و کلمات قرار نگیرد.
        </p>
