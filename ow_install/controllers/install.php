                ...
                case strpos($config, 'php.') === 0:
                    ...
                    switch ( $phpOption )
                    {
                        ...
                        case 'extensions':
                            ...
                            $checkDiff = OW::getEventManager()->trigger(new OW_Event(IISEventManager::ON_BEFORE_INSTALL_EXTENSIONS_CHECK, array('diff' => $diff)));
...
//        OW::getEventManager()->trigger(new OW_Event(IISEventManager::ON_AFTER_INSTALLATION_COMPLETED));
    }
    ...
    private static function sqlImport( $sqlFile )
    {
        ...
        OW::getEventManager()->trigger(new OW_Event(IISEventManager::ON_AFTER_SQL_IMPORT_IN_INSTALLING));
