...
class ADMIN_CTRL_Theme extends ADMIN_CTRL_Abstract
{
    ...
    public function getFloatbox( $params )
    {
        ...
        if ( isset($_POST['date']) && !empty($_POST['date']) )
        {
            ...
            $isJalali = false;
            $lbChangeEvent = OW::getEventManager()->trigger(new OW_Event(IISEventManager::ON_AFTER_DEFAULT_DATE_VALUE_SET, array('changeNewsJalaliToGregorian' => true, 'faYear' =>  (int)$tmpDateArray[0], 'faMonth'=> (int)$tmpDateArray[1] ,'faDay'=> 1)));
            ...
            $ubChangeEvent = OW::getEventManager()->trigger(new OW_Event(IISEventManager::ON_AFTER_DEFAULT_DATE_VALUE_SET, array('changeNewsJalaliToGregorian' => true, 'faYear' =>  (int)$tmpDateArray[0], 'faMonth'=> (int)$tmpDateArray[1] ,'faDay'=> (int)$tmpDateArray[2])));
