var OwUtils = function(){
    ...
    this.showImageInFloatBox = function( src )
    {
        ...
        $fakeImageC.css({display:'none',position:'absolute',left:'-9999px'});
...
function initAccordionButtonsProcessing(button){
    button.classList.toggle("active");
    $('.html_error_content_panel')[0].classList.toggle("show");
}
